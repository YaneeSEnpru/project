...
<link rel="stylesheet" type="text/css" href="  http://localhost/form_submit/css/style.css">
</head>
<body>
<div class="main">
<div id="content">
...
echo form_label(' <br/>User email: ', 'u_email');
$data= array(
'type' => 'email',
'name' => 'u_email',
...
echo "<label class='label_output'><br/>Entered Email: </label>".$user_email_id;
echo "<div>";
echo "</div>";
} ?>
</div>
